...
#include "turtlebot3_gazebo/traffic_signal_plugin.hpp"
...
void TrafficSignal::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  this->model = _model;
